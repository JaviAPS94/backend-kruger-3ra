...
//Vamos a agrupar nuestras rutas
//Utilizar router (que forma parate de express)
...
toysRouter.patch("/:id", updateToy);
toysRouter.delete("/:id", deleteToy);

// usersRouter.get("/", getToys);
// usersRouter.get("/:id", getToyById);
// usersRouter.post("/", createToy);
// usersRouter.patch("/:id", updateToy);
// usersRouter.delete("/:id", deleteToy);
